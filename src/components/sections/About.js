    ...
    <section className="about main-section flex-column-mobile" id="about">
      ...
      <div className="info flex-column-mobile">
        ...
        >
          <div>
            <div>
              <img className="my-photo" src="assets/risto.webp" alt="" />
            </div>
          </div>
        </div>
        {/* IMAGE ENDS */}
            ...
            <ul>
              ...
              <li>
                <span>
                  <span className="animated-layer fade-in-up-animation fadeInUp wow">
                    <span>Email :</span>
                    <span>ristotoldsep@gmail.com</span>
                  </span>
                </span>
              </li>
              <li>
      ...
      <div className="skills flex-column-mobile">
          ...
          <h3>
            <span>
              <span className="animated-layer fade-in-left-animation fadeInUp wow">
                About <span className="test">me</span>
              </span>
            </span>
          </h3>
          {/* MAIN TITLE ENDS */}
        ...
        <div className="about-me-content">
            ...
            <p className="animated-layer fade-in-up-animation fadeInUp wow">
            I am passionate about creating beautiful responsive web applications.
            </p>
            <p className="animated-layer fade-in-up-animation fadeInUp wow">
